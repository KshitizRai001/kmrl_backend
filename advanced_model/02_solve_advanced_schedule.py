...
def solve_advanced_schedule(input_data):
    ...
    This version calculates the final Health Score in the output as 1 - anomaly_score.
    """
    ...
    if status in [cp_model.OPTIMAL, cp_model.FEASIBLE]:
        ...
        for t_id in train_ids:
            ...
            anomaly_score = train_info.get('anomaly_score', 0.5)
            health_score = round(1 - anomaly_score, 2)
